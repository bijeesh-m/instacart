...
const Header = () => {
    return (
        <div >
            <header className=' flex px-10 py-3.5 items-center justify-between '>
                <div className=' flex gap-2'>
                    <Image src="/menu.svg" width={25} height={50} alt='menu-bar' />
                    <Image src="/logo.svg" width={150} height={50} alt='menu-bar' />
                </div>
                ...
                <div className=' font-semibold flex gap-3'>
                    <button className=' border border-[#C7C8CD] px-14 py-2 rounded-full '>
                        Login
                    </button>
                    <button className=' text-white bg-[#108910] border border-[#C7C8CD] px-14 py-2 rounded-full '>
                        Register
                    </button>
                </div>
            </header>
